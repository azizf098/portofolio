<template>
    ...
    <p class=" text-2xl font-semibold  text-gray-900 dark:text-blue-800" style="margin-left: 17%;">SOCIAL LINK</p>
    <ul class="ml-3" style="margin-left: 17%;">
        <li class="my-4"><a href="https://github.com/azizf098" aria-label="GITHUB" target="_blank" rel="noopener"
                class="w-min flex items-left hover:underline bg-white px-1 py-1 rounded-md text-black transition hover:translate-x-2 hover:no-underline"><svg
        ...
        <li class="my-4"><a href="https://www.instagram.com/aazizz.f/" aria-label="INSTAGRAM" target="_blank" rel="noopener"
